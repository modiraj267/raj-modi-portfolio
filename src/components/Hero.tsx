  ...
  return (
    <section id="start" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-cyber-primary/80 via-transparent to-cyber-primary z-10" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-20">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              href="#missions"
              className="px-8 py-3 rounded-full bg-cyber-cyan text-black font-semibold hover:bg-white transition-all shadow-[0_0_15px_rgba(0,214,255,0.4)]"
            >
              View Missions
            </a>
            <a
              ...
              download
              className="px-8 py-3 rounded-full border border-gray-600 hover:border-white transition-all"
            >
              Download Resume
            </a>
          </div>
          ...
          <motion.div
            ...
            className="mt-12 glassmorphism p-6 rounded-2xl max-w-md border-l-4 border-l-cyber-purple neon-border-hover"
          >
